...
public:
	 ...
	 */
	static HFONT AddFont(const std::wstring& strFontId, const std::wstring& strFontName, int nSize, bool bBold, bool bUnderline, bool bItalic, bool bStrikeout, bool bDefault);
	 ...
	 * @return 返回字体的 HFONT 句柄
	 */
	static HFONT GetFont(const std::wstring& strFontName, int nSize, bool bBold, bool bUnderline, bool bItalic, bool bStrikeout);
	 ...
	 *     @retval false 不存在
	 */
	static bool FindFont(const std::wstring& strFontName, int nSize, bool bBold, bool bUnderline, bool bItalic, bool bStrikeout);
